...
for (let i = 0; i < numConnections; i++) {
    const socket = io("http://20.23.136.144");
    //const socket = io("http://localhost:3000");


           socket.on("/topic/toggens.marketplace.bids", (data) => {
               counter++;
